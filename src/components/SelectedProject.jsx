...
export default function SelectedProject({ tasks }) {
    ...
    const { selectedProject, handleAddTask, handleProjectDelete, handleDeleteTask } = useContext(TasksContext);
    ...
    <div className="w-[35rem] mt-16">
      <header className="pb-4 mb-4 border-b-2 border-stone-300 ">
        <div className="flex items-center justify-between">
          ...
          <button onClick={handleProjectDelete} className="text-stone-600 hover:text-stone-950">Delete</button>
        </div>
